...
| Determine EBP behavior | [`../../../ebp/SPEC.md`](../../../ebp/SPEC.md) |
| Query structured EBP vocabulary | [`../../../ebp/contract.json`](../../../ebp/contract.json) |
| Understand Jetpacs ownership and dependency boundaries | [`../ARCHITECTURE-POC3.md`](../ARCHITECTURE-POC3.md) |
| Follow the implementation ladder | [`../REWRITE-PLAN.md`](../REWRITE-PLAN.md) |

## Authority

Use the source-of-truth order in [`../../AGENTS.md`](../../AGENTS.md). In particular:

1. EBP behavior comes from `../../../ebp/SPEC.md`.
