...
(defconst ebp--core-namespaces
  '("session" "auth" "surface" "queue" "event" "state" "dialog" "toast"
    ...
    ;; RF-4a (#154 drafted): the data projection module's method root.
    "data")
...
(defconst ebp--core-capabilities
  '("surfaces.notification" "surfaces.widget" "surfaces.tile"
    ...
    "offline.wake"
    ;; RF-4a (#154 drafted): the first spec-ratified use of the reserved
...
(defconst ebp--method-capabilities
  '((dialog\.show       . "surfaces.dialog")
    ...
    ;; RF-4a (#154 drafted): the data projection module's Emacs-sender
