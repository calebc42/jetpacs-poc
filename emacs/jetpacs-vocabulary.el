...
(defconst jetpacs-node-schema
  '(
    ...
    ("button" ("label" "on_tap") ("animate_shape" "checked" "enabled" "expanded" "icon" "on_change" "shape" "size" "variant"))
