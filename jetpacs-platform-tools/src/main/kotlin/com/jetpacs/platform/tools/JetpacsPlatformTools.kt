 ...
 *     jetpacs-platform-tools summarize jetpacs/companion/wire/src/...
...
fun main(rawArgs: Array<String>) {
    ...
    val workspace = try {
        Workspace.open(parsed.root, parsed.orgSource)
...
private data class CliArguments(
    ...
    companion object {
        ...
        fun usage(): String =
            ...
            |
            |Usage: jetpacs-platform-tools [--root PATH] [--org-source PATH] COMMAND [ARGS]
            |
            |Commands:
