...
internal class JetpacsWorkbench(internal val workspace: Workspace) {
    ...
    fun projectOverview(): String {
        ...
        return buildString {
            ...
            listOf(
                "jetpacs/docs/ARCHITECTURE-POC3.md",
                "jetpacs/docs/REWRITE-PLAN.md",
                "ebp-poc/ebp/SPEC.md",
                "ebp-poc/ebp/contract.json",
                "jetpacs/emacs/jetpacs-surfaces.el",
                "jetpacs/emacs/jetpacs-apps.el",
            ).filter { Files.isRegularFile(workspace.root.resolve(it)) }
    ...
    fun contractQuery(pointer: String?, search: String?): String {
        val contract = contractDocument()
            ?: throw UserInputException("no EBP contract.json found at ebp-poc/ebp/contract.json")
    ...
    fun architecture(topic: String?): String {
        ...
        val sections = linkedMapOf(
            "boundaries" to """
                ...
                |Source: jetpacs/docs/ARCHITECTURE-POC3.md and jetpacs/docs/REWRITE-PLAN.md.
            """.trimMargin(),
            "data_flow" to """
                |Durable data flow
                ...
                |Source: jetpacs/docs/ARCHITECTURE-POC3.md.
            """.trimMargin(),
            "elisp" to """
                |Elisp layering
                ...
                |Source: jetpacs/docs/REWRITE-PLAN.md, jetpacs/emacs/jetpacs-devtools.el, and jetpacs-applet-mcp/DETERMINISM.md.
            """.trimMargin(),
            "testing" to """
                |Testing ladder
                ...
                |Source: jetpacs/docs/ARCHITECTURE-POC3.md and jetpacs/docs/PLAN-jetpacs-apps.md.
            """.trimMargin(),
            "applets" to """
                |Applet contract
                ...
                |Source: jetpacs/emacs/jetpacs-apps.el and ebp-poc/ebp/SPEC.md.
            """.trimMargin(),
        )
    ...
    private fun contractDocument(): JsonObject? {
        val path = workspace.firstExisting("ebp-poc/ebp/contract.json") ?: return null
    ...
    private val patterns = linkedMapOf(
        "ebp_endpoint" to Pattern(
            ...
            listOf(
                PatternLocation("ebp-poc/ebp.el/lisp/ebp.el", "cl-defstruct (ebp-client"),
                PatternLocation(
                    "ebp-poc/ebp-kmp/wire/src/jvmMain/kotlin/com/calebc42/ebp/wire/CompanionEngine.kt",
        ...
        "durable_store" to Pattern(
            ...
            listOf(
                PatternLocation(
                    "ebp-poc/ebp-kmp/ebp-kmp/src/commonMain/kotlin/com/calebc42/ebp/wire/EbpDurableStore.kt",
                    "interface EbpDurableStore",
                ),
                PatternLocation(
                    "jetpacs/companion/core/ebp-store/src/commonMain/kotlin/com/calebc42/jetpacs/core/ebpstore/RoomEbpDurableStore.kt",
        ...
        "renderer_node" to Pattern(
            ...
            listOf(
                PatternLocation(
                    "ebp-poc/ebp-compose/renderer/compose/src/main/kotlin/com/calebc42/ebp/renderer/compose/CoreComposeRenderer.kt",
        ...
        "elisp_action" to Pattern(
            ...
            listOf(
                PatternLocation("jetpacs/emacs/jetpacs-surfaces.el", "cl-defun jetpacs-defaction"),
        ...
        "applet_registration" to Pattern(
            ...
            listOf(
                ...
                PatternLocation("jetpacs/emacs/jetpacs-apps.el", "cl-defun jetpacs-defapp"),
            ),
        ),
        "navigation" to Pattern(
            ...
            listOf(
                PatternLocation(
                    "jetpacs/companion/core/navigation/src/commonMain/kotlin/com/calebc42/jetpacs/core/navigation/JetpacsNavKey.kt",
