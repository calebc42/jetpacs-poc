 ...
 * EBP owns only its implementation-neutral vocabulary. Jetpacs's generated
...
object NodeSupport {
    ...
    val MATERIAL_APP_CONTRIBUTION = RendererContribution(
        ...
        nodeTypes = (NODE_SCHEMA.keys - CORE_NODE_SET) +
            JETPACS_MATERIAL3_TARGET_NODE_TYPES.getValue("app"),
        builtins = setOf(
            "view.switch",
            "surface.open",
        ...
        extensions = setOf(JETPACS_MATERIAL3_EXTENSION),
    )
    ...
    val MATERIAL_DIALOG_CONTRIBUTION = RendererContribution(
        ...
        ) + JETPACS_MATERIAL3_TARGET_NODE_TYPES.getValue("dialog"),
