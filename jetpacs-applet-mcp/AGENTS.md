...
- require a workspace `.el` file;
- reject every external read-only reference namespace and path outside the
  workspace;
...
emacs -Q --batch -L . -L ../ebp-poc/ebp.el/lisp -L ../jetpacs/emacs \
